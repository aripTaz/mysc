#!/bin/bash
# // PROJECT XDXL STORE
url_izin="https://raw.githubusercontent.com/aripTaz/permission/main/ip"
...
git clone https://github.com/aripTaz/permission.git /root/ipvps/ &> /dev/null
clear
echo -e ""
...
git remote add origin https://github.com/aripTaz/permission
git push -f https://${TOKEN}@github.com/aripTaz/permission.git &> /dev/null
rm -rf /root/ipvps
clear
